        ...
        <div className="qualification-sections">
          ...
          >
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">BACHELOR</h3>
            ...
            <div className="qualification-data">
              ...
              <div>
                <h3 className="qualification-title">SENIOR HS</h3>
                <span className="qualification-subtitle">
            ...
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">JUNIOR HS</h3>
                <span className="qualification-subtitle">
          ...
          >
            ...
            <div className="qualification-data">
              <div data-aos="zoom-in-up">
                <h3 className="qualification-title">DISPATCH ADMIN</h3>
                <span className="qualification-subtitle">
            ...
            <div className="qualification-data">
              ...
              <div data-aos="zoom-in-up">
                <h3 className="qualification-title">TECHNICAL SUPPORT</h3>
                <span className="qualification-subtitle">
                  <h3>COMELEC</h3>
